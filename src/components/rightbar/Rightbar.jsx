      ...
      <>
        ...
        <div className="rightbarInfo">
          ...
          <div className="rightbarInfoItem">
            ...
            <span className="rightbarInfoValue">Nagpur</span>
          </div>
          <div className="rightbarInfoItem">
        ...
        <div className="rightbarFollowings">
          ...
          <div className="rightbarFollowing">
            <img
              ...
              className="rightbarFollowingImg"
            />
            <span className="rightbarFollowingName">Karina</span>
          </div>
          <div className="rightbarFollowing">
            <img
          ...
          <div className="rightbarFollowing">
            <img
              ...
              className="rightbarFollowingImg"
            />
            <span className="rightbarFollowingName">Gita</span>
          </div>
          <div className="rightbarFollowing">
            <img
              ...
              className="rightbarFollowingImg"
            />
            <span className="rightbarFollowingName">Rani</span>
          </div>
        </div>
      </>
    );
